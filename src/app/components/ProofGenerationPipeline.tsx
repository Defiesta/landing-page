    ...
    <div className="bg-gray-900/60 rounded-2xl p-4 md:p-6 border border-gray-700/50 font-sans">
      ...
      <div className="bg-slate-800/30 rounded-xl border-2 border-dashed border-purple-500/30 p-3 md:p-4 relative">
        ...
        <div className="mt-4 space-y-3">
          ...
          <div className="flex justify-center">
            <svg width="20" height="16" viewBox="0 0 20 16" fill="none">
              <path d="M10 0 L10 10" stroke="#8B5CF6" strokeWidth="2"/>
              <path d="M6 8 L10 14 L14 8" fill="#8B5CF6"/>
            </svg>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-900/40 to-blue-800/20 rounded-lg p-3 border border-blue-700/50">
            <div className="flex items-start gap-2 md:gap-3">
              <div className="flex-shrink-0">
                <div className="w-7 h-7 md:w-8 md:h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white font-bold text-xs md:text-sm">
                  3
                </div>
              </div>
              <div className="flex-1 min-w-0">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-2">
                    <div className="text-blue-200 text-xs font-semibold mb-1">Continuation</div>
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <div className="w-8 md:w-12 h-2 bg-blue-700 rounded-sm"></div>
                        <span className="text-xs text-slate-400">Seg₀</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-8 md:w-12 h-2 bg-blue-600 rounded-sm"></div>
                        <span className="text-xs text-slate-400">Seg₁ ...</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Right: FRI Protocol */}
                  <div className="bg-slate-900/50 rounded-lg p-2">
                    <div className="text-blue-200 text-xs font-semibold mb-1">FRI Params</div>
                ...
                <div className="mt-2 flex flex-wrap items-center gap-1.5 text-xs">
                  <div className="bg-blue-800/50 px-2 py-0.5 rounded text-blue-200">
                    GPU Accel
                  </div>
                  <div className="bg-blue-800/50 px-2 py-0.5 rounded text-blue-200">
                    ~100-bit security
            ...
            <div className="flex items-start gap-2 md:gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="grid grid-cols-3 gap-1.5 md:gap-2">
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-1.5 md:p-2 text-center">
                    <div className="text-blue-300 font-mono text-sm mb-0.5">J</div>
                    <div className="text-xs text-slate-400 hidden sm:block">Journal</div>
                    <div className="text-xs text-blue-400 font-mono">var</div>
                  </div>
                </div>
              </div>
            </div>
