      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          <h5 className="text-xl font-semibold text-white mb-2">
            DeFiesta Operating Envelope (MVP)
          </h5>
          ...
          <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-cyan-300 font-mono">10–20M cycles / run</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-slate-400">Target:</span>
                <span className="text-cyan-300 font-mono">sub-10s end-to-end (MVP)</span>
              </div>
              <div className="text-slate-500 text-xs mt-2 pt-2 border-t border-slate-700">
