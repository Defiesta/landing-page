      ...
      <div className="space-y-4">
        ...
        <div className="bg-purple-900/20 rounded-xl p-4 border border-purple-700/50">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Stage 1 */}
            <div className="bg-blue-900/40 rounded-lg p-4 border border-blue-600/50">
              <div className="flex items-center gap-2 mb-3">
                <div className="w-7 h-7 bg-blue-500 text-white rounded-full flex items-center justify-center font-bold text-sm">
                  1
                </div>
          ...
          <div className="flex justify-center my-3">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M12 4 L12 18" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round"/>
              <path d="M6 14 L12 20 L18 14" stroke="#8B5CF6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </div>
        </div>
